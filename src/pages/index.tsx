...
import LogoKanap from "../assets/LogoKanap.svg";
    ...
    <>
      ...
      <main>
        ...
        <section>
          ...
          <Projet
            titleLogo={LogoKanap}
            lien="https://remybreton.github.io/Kanap/front/html/"
            content=" Ce projet consiste en la création d'un site e-commerce en utilisant JavaScript pour rendre l'interface utilisateur dynamique. Le site permettra aux utilisateurs de parcourir les produits, de les ajouter au panier et de passer une commande. De plus, un plan de test sera mis en place pour garantir la qualité du site."
          />
          <Projet
            titleLogo={LogoKasa}
